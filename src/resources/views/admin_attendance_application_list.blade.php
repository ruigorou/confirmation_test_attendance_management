...
@section('css')
    <link rel="stylesheet" href="{{ asset('css/admin_attendance_application_list.css') }}">
@endsection
@section('content')
<div class="application-list">
    ...
    <div class="application-list__tabs">
        <a class="application-list__tab {{ $tab === '承認待ち' ? 'application-list__tab--active' : '' }}"
           href="{{ route('admin.attendance.application.list', ['tab' => '承認待ち']) }}">承認待ち</a>
        <a class="application-list__tab {{ $tab === '承認済み' ? 'application-list__tab--active' : '' }}"
           href="{{ route('admin.attendance.application.list', ['tab' => '承認済み']) }}">承認済み</a>
    </div>
            ...
            <tr class="application-list__tr">
                ...
                <td class="application-list__td">
                    <a class="application-list__detail-link"
                       href="{{ route('admin.approval.approve', ['attendance_correct_request_id' => $attendance->id]) }}">詳細</a>
                </td>
            </tr>
            @empty
            <tr class="application-list__tr">
